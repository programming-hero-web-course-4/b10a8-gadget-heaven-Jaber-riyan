        ...
        <div>
            ...
            <div className="bg-[#9538E2] mt-16">
                <div className="mb-8 pt-5">
                    <h1 className="font-bold text-3xl text-white text-center mb-6">Statistics</h1>
            ...
            {/* banner end  */}
            <h3 className='text-red-500 text-4xl font-bold text-center mt-[83px] mb-[82px]'>Statistics</h3>
            <Footer></Footer>
        </div>
    );
};
